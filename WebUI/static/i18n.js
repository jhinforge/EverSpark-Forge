...
(() => {
  const zh = {
    ...
    "Each character has four JSON documents. Ask Concept Forge to revise a selected group; viewing a character does not switch your active conversation.": "每个角色包含四份 JSON。你可以让 Concept Forge 修改指定内容；查看其他角色不会切换当前对话。",
    ...
    "Select local models, outputs, and character JSON files. Back up Memory too to preserve subject links and revisions.": "选择本地模型、输出文件和角色 JSON。建议同时备份 Memory，以保存角色关联与修订记录。",
    "Scan changes": "扫描本地文件",
    ...
    "Upload failed": "上传失败",
    "Select a file or Memory snapshot first.": "请先选择文件或 Memory 快照。",
