...
(() => {
  const zh = {
    ...
    "WORKSPACE / MODEL SERVICES": "工作区 / 模型服务",
    ...
    "Connect language models.": "连接语言模型。",
    "Refresh": "刷新",
    ...
    "Model service": "模型服务",
    "Connect an OpenAI Compatible service and choose its model in Forge.": "连接 OpenAI Compatible 服务，然后在 Forge 选择模型。",
    "Refresh connections": "刷新连接",
    "Add model service": "添加模型服务",
    "Edit model service": "编辑模型服务",
    "Use the exact base URL and model ID from your provider. API keys stay on this server and are never shown again.": "填写服务商提供的准确基础地址和模型 ID。API Key 保存在本机服务端，保存后不会再次显示。",
    "Connection name": "连接名称",
    "API base URL": "API 基础地址",
    "Model ID": "模型 ID",
    "API Key": "API Key",
    "Send JSON mode for structured requests": "结构化请求启用 JSON 模式",
    "Leave JSON mode off if your provider does not support response_format.": "如果服务不支持 response_format，请保持关闭。",
    "Test connection": "测试连接",
    "Save connection": "保存连接",
    "Cancel edit": "取消编辑",
    "Default model service": "默认模型服务",
    "Built-in connection": "内置连接",
    "API Key saved on server": "API Key 已保存在服务端",
    "Edit connection": "编辑连接",
    "Remove connection": "删除连接",
    "Remove this model connection?": "确定删除此模型连接吗？",
    "Model connection saved.": "模型连接已保存。",
    "Model connection works.": "模型连接测试成功。",
    "Add": "添加",
    ...
    "Checkpoint or diffusion model": "Checkpoint 或扩散模型",
    "Model type": "模型类型",
    "Direct URL": "直链地址",
    "File name": "文件名",
    "optional": "可选",
    "Download base model": "下载基础模型",
    "LoRA model": "LoRA 模型",
    "VAE model": "VAE 模型",
    "Download LoRA": "下载 LoRA",
    "Download VAE": "下载 VAE",
